...
`;customElements.define("view-home",class extends J{static get properties(){return{}}constructor(){super()}goPage(e){e.preventDefault();let t=e.target.getAttribute("name");ne.dispatch(ce(t))}static get styles(){return[de,o`
                :host {
                    position: absolute;
                    display: block;
                    margin: 0;
...
`;class pe extends(me(ne)(J)){static get properties(){return{siteTree:{type:Object},renderValue:{type:String}}}constructor(){super(),this.siteTree={}}stateChanged(e){this.siteTree=e.siteTree,this.renderValue=e.renderValue}idPage(){var e=[];if("project1"==this.renderValue)return[3,3];if("project1Lv"==this.renderValue)return[3,3];for(var t=0;t<this.siteTree.length;t++)if(this.siteTree[t].name==this.renderValue)return e.push(t-1,t+1),e}downPage(e){e.preventDefault();var t=this.siteTree.length;this.idPage()[0]<0?ne.dispatch(ce(this.siteTree[t].name)):ne.dispatch(ce(this.siteTree[this.idPage()[0]].name))}upPage(e){e.preventDefault();var t=this.siteTree.length;this.idPage()[1]>=t?ne.dispatch(ce(this.siteTree[0].name)):ne.dispatch(ce(this.siteTree[this.idPage()[1]].name))}goPage(e){if(e.preventDefault(),"project1"==this.renderValue)ne.dispatch(ce("projects"));else if("project1Lv"==this.renderValue)ne.dispatch(ce("project1"));else{let t=e.target.getAttribute("name");ne.dispatch(ce(t))}}titlePagei(){if("project1"==this.renderValue)return"DBAE";for(var e=0;e<this.siteTree.length;e++)if(this.siteTree[e].name==this.renderValue)return this.siteTree[e].title}static get styles(){return[le,o`
                :host {
                    position: relative;
                    display: block;
                    margin: 0;
...
/* Responsive Web Design */
    ...
    @media(min-width: 720px) {
        ...
        .col-11 {width: 91.66%;}
        .col-12 {width: 100%;}
`;customElements.define("ttech-perscardvi",class extends J{static get styles(){return[ue,o`
                :host {
                    position: relative;
                    display: block;
                    margin: 0;
...
/* Responsive Web Design */
    ...
    @media(min-width: 720px) {
        ...
        .col-11 {width: 91.66%;}
        .col-12 {width: 100%;}
`;customElements.define("ttech-tabtextvi",class extends J{static get properties(){return{text:{type:String},btColor1:{type:String},btColor2:{type:String},btColor3:{type:String}}}constructor(){super(),this.text="mision",this.btColor1="#c9f69c",this.btColor2="#d1abf7",this.btColor3="#d1abf7"}goText(e){e.preventDefault();let t=e.target.getAttribute("name");this.text=t,"mision"==t?(this.btColor1="#c9f69c",this.btColor2="#d1abf7",this.btColor3="#d1abf7"):"vision"==t?(this.btColor1="#d1abf7",this.btColor2="#c9f69c",this.btColor3="#d1abf7"):(this.btColor1="#d1abf7",this.btColor2="#d1abf7",this.btColor3="#c9f69c")}static get styles(){return[ge,o`
                :host {
                    position: relative;
                    display: block;
                    margin: 0;
...
/* Responsive Web Design */
    ...
    @media(min-width: 720px) {
        ...
        .col-11 {width: 91.66%;}
        .col-12 {width: 100%;}
`;class we extends(me(ne)(J)){static get properties(){return{siteTree:{type:Object},renderValue:{type:String},pjPs:{type:Number}}}constructor(){super(),this.siteTree={},this.pjPs=0}stateChanged(e){this.siteTree=e.siteTree,this.renderValue=e.renderValue}goPage(e){e.preventDefault();let t=e.target.getAttribute("name");ne.dispatch(ce(t))}static get styles(){return[be,o`
                :host {
                    position: relative;
                    display: block;
                    margin: 0;
...
`;customElements.define("view-about",class extends J{static get properties(){return{proptyName:{type:String}}}constructor(){super(),this.proptyName="pname"}static get styles(){return[fe,o`
                :host {
                    position: absolute;
                    display: block;
                    margin: 0;
...
`;customElements.define("view-projects",class extends J{static get properties(){return{proptyName:{type:String},pjPs:{type:Number}}}constructor(){super(),this.proptyName="pname",this.pjPs=0}static get styles(){return[ye,o`
                :host {
                    position: absolute;
                    display: block;
                    margin: 0;
...
`;class Ce extends(me(ne)(J)){static get properties(){return{siteTree:{type:Object},leveli:{type:Number},areai:{type:Number},contIndex:{type:Number},aux:{type:Number},title:{type:String},image:{tipe:String},link:{type:String}}}constructor(){super(),this.leveli=0,this.areai=0,this.contIndex=0,this.aux=0,this.title="test",this.image="src/img/pjts/dbae/mbr-1920x1357.jpg",this.link="https://www.youtube.com/embed/-lT4HzqDyiI"}stateChanged(e){this.siteTree=e.siteTree,this.areai=e.areaValue}medias(){if(console.log(this.contIndex),this.contIndex<this.siteTree[3].projects[0].levels[this.leveli].areas[this.areai].contents.length)return this.title=this.siteTree[3].projects[0].levels[this.leveli].areas[this.areai].contents[this.contIndex].title,this.link=this.siteTree[3].projects[0].levels[this.leveli].areas[this.areai].contents[this.contIndex].iframe,T`<ttech-mdcardvi titlei=${this.title} imagei=${this.image} linki=${this.link}></ttech-mdcardvi>`}indexCont(){this.contIndex++}static get styles(){return[$e,o`
        ...
        `}}customElements.define("view-project1lv",Ce);const _e=o`
...
`;customElements.define("view-contact",class extends J{static get properties(){return{proptyName:{type:String}}}constructor(){super(),this.proptyName="pname"}static get styles(){return[_e,o`
                :host {
                    position: absolute;
                    display: block;
                    margin: 0;
