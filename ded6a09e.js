...
`;customElements.define("view-home",class extends Q{static get properties(){return{}}constructor(){super()}goPage(e){e.preventDefault();let t=e.target.getAttribute("name");ne.dispatch(ce(t))}static get styles(){return[de,o`
                :host {
                    position: absolute;
                    display: block;
                    margin: 0;
...
*/
const me=e=>t=>class extends t{connectedCallback(){super.connectedCallback&&super.connectedCallback(),this._storeUnsubscribe=e.subscribe((()=>this.stateChanged(e.getState()))),this.stateChanged(e.getState())}disconnectedCallback(){this._storeUnsubscribe(),super.disconnectedCallback&&super.disconnectedCallback()}stateChanged(e){}},le=o`
    .navTreeVI {
        position: relative;
        display: flex;
        justify-content: center;
...
`;class pe extends(me(ne)(Q)){static get properties(){return{siteTree:{type:Object},renderValue:{type:String}}}constructor(){super(),this.siteTree={}}stateChanged(e){this.siteTree=e.siteTree,this.renderValue=e.renderValue}idPage(){var e=[];if("project1"==this.renderValue)return[3,3];if("project1Lv"==this.renderValue)return[3,3];for(var t=0;t<this.siteTree.length;t++)if(this.siteTree[t].name==this.renderValue)return e.push(t-1,t+1),e}downPage(e){e.preventDefault();var t=this.siteTree.length;this.idPage()[0]<0?ne.dispatch(ce(this.siteTree[t].name)):ne.dispatch(ce(this.siteTree[this.idPage()[0]].name))}upPage(e){e.preventDefault();var t=this.siteTree.length;this.idPage()[1]>=t?ne.dispatch(ce(this.siteTree[0].name)):ne.dispatch(ce(this.siteTree[this.idPage()[1]].name))}goPage(e){if(e.preventDefault(),"project1"==this.renderValue)ne.dispatch(ce("projects"));else if("project1Lv"==this.renderValue)ne.dispatch(ce("project1"));else{let t=e.target.getAttribute("name");ne.dispatch(ce(t))}}titlePagei(){if("project1"==this.renderValue)return"DBAE";for(var e=0;e<this.siteTree.length;e++)if(this.siteTree[e].name==this.renderValue)return this.siteTree[e].title}static get styles(){return[le,o`
                :host {
                    position: relative;
                    display: block;
                    margin: 0;
            ...
            `}}customElements.define("ttech-nav",pe);const he=o`
    a {
...
`;customElements.define("ttech-mediainfovi",class extends Q{static get properties(){return{proptyName:{type:String}}}constructor(){super(),this.proptyName="pname"}goToTab(e){e.preventDefault(),window.open("https://drive.google.com/file/d/1JdwIsWmzxUYXVnve-wU1TE2r3U1_CQYa/view?usp=sharing","_blank").focus()}static get styles(){return[he,o`
                :host {
                    position: relative;
                    display: block;
                    margin: 0;
        ...
        <div class="mediainfovi">
            <div class="row">
                <div class="descript col-5">
                    ...
                    <p>TEXTO "Presentación"</p>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa dolores nobis debitis porro cumque necessitatibus, cum voluptatibus odio distinctio sapiente dolorum vero voluptas aliquam voluptates. Ipsum ex consequatur, natus in quam optio ducimus delectus magni repudiandae hic repellat praesentium aut dicta. Laboriosam incidunt qui quae. Ratione quod tenetur corporis quaerat.</p>
...
/* Responsive Web Design */
    ...
    @media(min-width: 720px) {
        ...
        .col-11 {width: 91.66%;}
        .col-12 {width: 100%;}
`;customElements.define("ttech-perscardvi",class extends Q{static get styles(){return[ue,o`
                :host {
                    position: relative;
                    display: block;
                    margin: 0;
        ...
        <div class="perscardvi">
            ...
            <div class="cards">
                ...
                <h5>Position</h5>
                <h4>Name</h4>
                <p>DESCRIPTION Lorem, ipsum dolor sit amet consectetur adipisicing elit. Beatae, veniam?</p>
            </div>  
        </div>
        `}});const ge=o`
.tabtextvi {
...
/* Responsive Web Design */
    ...
    @media(min-width: 720px) {
        ...
        .col-11 {width: 91.66%;}
        .col-12 {width: 100%;}
`;customElements.define("ttech-tabtextvi",class extends Q{static get properties(){return{text:{type:String},btColor1:{type:String},btColor2:{type:String},btColor3:{type:String}}}constructor(){super(),this.text="mision",this.btColor1="#c9f69c",this.btColor2="#d1abf7",this.btColor3="#d1abf7"}goText(e){e.preventDefault();let t=e.target.getAttribute("name");this.text=t,"mision"==t?(this.btColor1="#c9f69c",this.btColor2="#d1abf7",this.btColor3="#d1abf7"):"vision"==t?(this.btColor1="#d1abf7",this.btColor2="#c9f69c",this.btColor3="#d1abf7"):(this.btColor1="#d1abf7",this.btColor2="#d1abf7",this.btColor3="#c9f69c")}static get styles(){return[ge,o`
                :host {
                    position: relative;
                    display: block;
                    margin: 0;
        ...
        <div class="tabtextvi">
            ...
            <div class="rendered">
                ...
                ${"value"==this.text?T`<p>Transversalidad: nuestro quehacer tiene por bien superior el acceso universal a la información y comunicación.
Neutralidad: fundación FILSA no impone perspectiva alguna al momento de trabajar y hacer accesible la información. Tampoco sus miembros imponen gustos o preferencias personales en su labor.
Confidencialidad: el trabajo de nuestra fundación se basa en el ejercicio ético de la confidencialidad, procurando el manejo adecuado de la información.
Fidelidad: propendemos el mejoramiento continuo para ser fieles a la información que deba trasladarse de una lengua a otra.</p>`:""}
            </div> 
        </div>
        `}});const be=o`
...
/* Responsive Web Design */
    ...
    @media(min-width: 720px) {
        ...
        .col-11 {width: 91.66%;}
        .col-12 {width: 100%;}
`;class we extends(me(ne)(Q)){static get properties(){return{siteTree:{type:Object},renderValue:{type:String},pjPs:{type:Number}}}constructor(){super(),this.siteTree={},this.pjPs=0}stateChanged(e){this.siteTree=e.siteTree,this.renderValue=e.renderValue}goPage(e){e.preventDefault();let t=e.target.getAttribute("name");ne.dispatch(ce(t))}static get styles(){return[be,o`
                :host {
                    position: relative;
                    display: block;
                    margin: 0;
        ...
        `}}customElements.define("ttech-pjcardvi",we);const ve=o`
...
/* Responsive Web Design */
    ...
    @media(min-width: 720px) {
        ...
        .col-11 {width: 91.66%;}
        .col-12 {width: 100%;}
`;customElements.define("ttech-mdcardvi",class extends Q{static get properties(){return{titlei:{type:String},imagei:{tipe:String},linki:{type:String}}}constructor(){super(),this.titlei="TITLE",this.imagei="src/img/pjts/dbae/mbr-1920x1357.jpg",this.linki="https://www.youtube.com/embed/-lT4HzqDyiI"}goToTab(e){e.preventDefault(),window.open(this.linki,"_blank").focus()}static get styles(){return[ve,o`
                :host {
                    position: relative;
                    display: block;
                    margin: 0;
        ...
        <div class="mdcardvi">
            <div class="cards">
                ...
                <p>${this.titlei}</p>
                <button class="btn-home" @click="${this.goToTab}"> contenido </button>
            </div>
        </div>
        `}});const fe=o`
...
`;customElements.define("view-about",class extends Q{static get properties(){return{proptyName:{type:String}}}constructor(){super(),this.proptyName="pname"}static get styles(){return[fe,o`
                :host {
                    position: absolute;
                    display: block;
                    margin: 0;
...
`;customElements.define("view-news",class extends Q{static get properties(){return{proptyName:{type:String}}}constructor(){super(),this.proptyName="pname"}static get styles(){return[xe,o`
                :host {
                    position: absolute;
                    display: block;
                    margin: 0;
...
`;customElements.define("view-projects",class extends Q{static get properties(){return{proptyName:{type:String},pjPs:{type:Number}}}constructor(){super(),this.proptyName="pname",this.pjPs=0}static get styles(){return[ye,o`
                :host {
                    position: absolute;
                    display: block;
                    margin: 0;
...
`;customElements.define("view-project1",class extends Q{static get properties(){return{proptyName:{type:String}}}constructor(){super(),this.proptyName="pname"}goPage(e){e.preventDefault();let t=e.target.getAttribute("name"),i=e.target.getAttribute("leveli"),s=e.target.getAttribute("areai");ne.dispatch({type:"levelValue",level:i}),ne.dispatch({type:"areaValue",area:s}),ne.dispatch(ce(t))}static get styles(){return[je,o`
                :host {
                    position: absolute;
                    display: block;
                    margin: 0;
...
`;class _e extends(me(ne)(Q)){static get properties(){return{siteTree:{type:Object},leveli:{type:Number},areai:{type:Number},contIndex:{type:Number},aux:{type:Number},title:{type:String},image:{tipe:String},link:{type:String}}}constructor(){super(),this.leveli=0,this.areai=0,this.contIndex=0,this.aux=0,this.title="test",this.image="src/img/pjts/dbae/mbr-1920x1357.jpg",this.link="https://www.youtube.com/embed/-lT4HzqDyiI"}stateChanged(e){this.siteTree=e.siteTree,this.areai=e.areaValue}medias(){if(console.log(this.contIndex),this.contIndex<this.siteTree[3].projects[0].levels[this.leveli].areas[this.areai].contents.length)return this.title=this.siteTree[3].projects[0].levels[this.leveli].areas[this.areai].contents[this.contIndex].title,this.link=this.siteTree[3].projects[0].levels[this.leveli].areas[this.areai].contents[this.contIndex].iframe,T`<ttech-mdcardvi titlei=${this.title} imagei=${this.image} linki=${this.link}></ttech-mdcardvi>`}indexCont(){this.contIndex++}static get styles(){return[$e,o`
                :host {
                    position: absolute;
                    display: block;
                    margin: 0;
            ...
            <div class="pjOne">
                <!-- nav to project -->
                <ttech-nav></ttech-nav>
                <h3>${this.siteTree[3].projects[0].levels[this.leveli].areas[this.areai].aNames}</h3>
                <div class="levels">
                    <div>
                        ${this.medias()}
                        ${this.indexCont()}
        ...
        `}}customElements.define("view-project1lv",_e);const Ce=o`
...
`;customElements.define("view-contact",class extends Q{static get properties(){return{proptyName:{type:String}}}constructor(){super(),this.proptyName="pname"}static get styles(){return[Ce,o`
                :host {
                    position: absolute;
                    display: block;
                    margin: 0;
        ...
        `}});customElements.define("app-render",class extends Q{static get properties(){return{selected:{type:String}}}constructor(){super(),this.selected="home"}static get styles(){return o`
            :host {
                display: block;
                position: absolute;
                height: 100%;
...
`;class Ee extends(me(ne)(Q)){static get properties(){return{renderValue:{type:String},mSelected:{type:String},nSelected:{type:String},opened:{type:Boolean}}}constructor(){super(),this.mSelected="Inicio",this.nSelected="home"}stateChanged(e){this.renderValue=e.renderValue,console.log(e.renderValue,e.levelValue,e.areaValue)}goPage(e){e.preventDefault();let t=e.target.getAttribute("name");ne.dispatch(ce(t))}mgMenu(e){e.preventDefault(),1==this.opened?this.opened=!1:this.opened=!0}mgMenuClose(e){e.preventDefault(),1==this.opened&&(this.opened=!1)}static get styles(){return[ke,o`
                :host {
                    display: block;
                }
            `]}render(){return T`
        ...
        `}}customElements.define("app-call",Ee);
